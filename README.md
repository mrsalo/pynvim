...
This will leave you with an IPython Session that has a variable named "nvim" which 
...
instance it shall connect to. Afterwards see (README.md#usage-through-the-python-repl)
